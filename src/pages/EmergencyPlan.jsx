...
const defaultPlan = {
  ...
  emergencyContacts: [{ id: 1, name: "", phone: "", relationship: "" }],
  evacuation: {
    primaryRoute: "",
    alternateRoute: "",
    nearestEvacCenter: "",
...
const defaultChecklist = [
  ...
  },
  {
    id: 6,
    category: "Water & Food",
    item: "Canned goods (3-day supply)",
    checked: false,
  },
  {
    id: 7,
  ...
  { id: 11, category: "First Aid", item: "Pain relievers", checked: false },
  {
    id: 12,
    category: "First Aid",
    item: "Bandages and antiseptic",
    checked: false,
  },
  {
    id: 13,
    category: "Tools & Safety",
    item: "Flashlight with extra batteries",
    checked: false,
  },
  {
    id: 14,
    category: "Tools & Safety",
    item: "Battery-powered radio",
    checked: false,
  },
  {
    id: 15,
    category: "Tools & Safety",
    item: "Whistle (for signaling)",
    checked: false,
  },
  {
    id: 16,
    category: "Tools & Safety",
    item: "Multi-tool or knife",
    checked: false,
  },
  ...
  { id: 19, category: "Clothing", item: "Sturdy shoes", checked: false },
  {
    id: 20,
    category: "Clothing",
    item: "Blanket or sleeping bag",
    checked: false,
  },
  {
    id: 21,
    category: "Communication",
    item: "Fully charged power bank",
    checked: false,
  },
  { id: 22, category: "Communication", item: "Phone charger", checked: false },
  {
    id: 23,
    category: "Communication",
    item: "Emergency cash (small bills)",
    checked: false,
  },
  {
    id: 24,
...
export default function EmergencyPlan() {
  ...
  const resetToDefault = () => {
    if (
      window.confirm(
        "Reset to default checklist? This will remove any custom items.",
      )
    ) {
  ...
  return (
    <div
      ...
      data-testid="emergency-plan-page"
    >
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto space-y-6">
        ...
        {saved && (
          <div
            className="p-4 rounded-xl flex items-center gap-3 animate-fadeIn bg-green-500 text-white"
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center justify-between bg-yellow-500 text-blue-950 px-4 py-3 rounded-xl font-semibold hover:bg-yellow-400 transition-colors"
          >
          ...
          {showDropdown && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-lg border border-slate-200 z-10">
        ...
        <div className="bg-blue-950 rounded-xl p-4" data-testid="info-card">
          ...
          <p className="text-white/80 text-sm">
            Create your family's emergency plan. Your plan is saved on this
            device.
          </p>
        </div>
          ...
          <div className="space-y-6" data-testid="checklist-section">
            ...
            <div className="space-y-4" data-testid="checklist-categories">
              {groupedItems.map(({ category, items }) => (
                ...
                >
                  <div
                    className={`p-4 ${categoryColors[category]} flex items-center justify-between`}
                  >
                ...
                {plan.familyMembers.map((member) => (
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateFamilyMember(member.id, "medical", e.target.value)
                      }
        ...
        {activeSection === "meeting" && (
          <div
            className="bg-white rounded-xl p-4 space-y-4"
            data-testid="meeting-section"
          >
            <h3 className="text-blue-950 font-bold">Meeting Points</h3>
            <p className="text-slate-500 text-sm">
              Designate meeting locations for different scenarios
            </p>
            ...
            <div className="space-y-3">
              {plan.meetingPoints.map((point) => (
                <div
                  ...
                  data-testid={`meeting-point-${point.id}`}
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateMeetingPoint(point.id, e.target.value)
                    }
                    className="w-full bg-white border border-slate-200 rounded-lg p-2 text-sm"
                  />
                </div>
        ...
        {activeSection === "evacuation" && (
          <div
            className="bg-white rounded-xl p-4 space-y-4"
            data-testid="evacuation-section"
          >
            <h3 className="text-blue-950 font-bold">Evacuation Routes</h3>

            <div className="space-y-3">
              <div>
                <label className="text-slate-600 text-sm block mb-1">
                  Primary Route
                </label>
                <input
                  type="text"
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPlan((prev) => ({
                      ...
                      evacuation: {
                        ...prev.evacuation,
                        nearestEvacCenter: e.target.value,
                      },
                    }))
                  }
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm"
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <textarea
                  ...
                  value={plan.pets}
                  onChange={(e) =>
                    setPlan((prev) => ({ ...prev, pets: e.target.value }))
                  }
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm min-h-[80px] resize-none"
                />
              </div>
